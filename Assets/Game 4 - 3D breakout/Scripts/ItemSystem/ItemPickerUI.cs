...
/// <summary>
/// Shows 3 item choices after every 3rd level. Each card has a spinning 3D placeholder
...
public class ItemPickerUI : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < choices.Length; i++)
        {
            ...
            GUI.Label(new Rect(card.x + 6, textY, card.width - 12, 28), choices[i].itemName, nameStyle);
